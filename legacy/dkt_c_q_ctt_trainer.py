...
class DKT_c_q_ctt_trainer():
    ...
    def _train(self, train_loader, metric_name):
        ...
        for idx, data in enumerate(tqdm(train_loader)):
            ...
            y_hat = self.model( q_seqs.long(), r_seqs.long(), pid_seqs.long(), diff_seqs.long() ) #|y_hat| = (bs, sq, self.num_q) -> tensor([[[0.6938, 0.7605, ..., 0.7821], [0.8366, 0.6598,  ..., 0.8514],..)
    ...
    def _validate(self, valid_loader, metric_name):
        ...
        with torch.no_grad():
            for data in tqdm(valid_loader):
                ...
                y_hat = self.model( q_seqs.long(), r_seqs.long(), pid_seqs.long(), diff_seqs.long() )
