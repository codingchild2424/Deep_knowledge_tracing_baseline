...
class SAKT_c_rasch_trainer():
    ...
    def _train(self, train_loader, metric_name):
        ...
        for idx, data in enumerate(tqdm(train_loader)):
            ...
            y_hat, _ = self.model( q_seqs.long(), r_seqs.long(), qshft_seqs.long(), pid_seqs.long() ) #|y_hat| = (bs, sq, self.num_q) -> tensor([[[0.6938, 0.7605, ..., 0.7821], [0.8366, 0.6598,  ..., 0.8514],..)
