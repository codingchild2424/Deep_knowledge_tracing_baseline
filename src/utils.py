...
def dkt_collate_fn(batch, pad_val=-1):
...
def dkt_pid_collate_fn(batch, pad_val=-1):
    ...
    #즉 전체를 qshft_seqs의 -1이 아닌 갯수만큼은 true(1)을 곱해서 원래 값을 부여하고, 아닌 것은 False(0)을 곱해서 0으로 만듦
    q_seqs, r_seqs, qshft_seqs, rshft_seqs, pid_seqs = \
        q_seqs * mask_seqs, r_seqs * mask_seqs, qshft_seqs * mask_seqs, \
        rshft_seqs * mask_seqs, pid_seqs * mask_seqs

    return q_seqs, r_seqs, qshft_seqs, rshft_seqs, pid_seqs, mask_seqs
...
def dkt_pid_diff_collate_fn(batch, pad_val=-1):
    ...
    #즉 전체를 qshft_seqs의 -1이 아닌 갯수만큼은 true(1)을 곱해서 원래 값을 부여하고, 아닌 것은 False(0)을 곱해서 0으로 만듦
    q_seqs, r_seqs, qshft_seqs, rshft_seqs, pid_seqs, diff_seqs = \
        q_seqs * mask_seqs, r_seqs * mask_seqs, qshft_seqs * mask_seqs, \
        rshft_seqs * mask_seqs, pid_seqs * mask_seqs, diff_seqs * mask_seqs

    return q_seqs, r_seqs, qshft_seqs, rshft_seqs, pid_seqs, diff_seqs, mask_seqs
    #|q_seqs| = (batch_size, maximum_sequence_length_in_the_batch)
    #|r_seqs| = (batch_size, maximum_sequence_length_in_the_batch)
    #|qshft_seqs| = (batch_size, maximum_sequence_length_in_the_batch)
    #|rshft_seqs| = (batch_size, maximum_sequence_length_in_the_batch)
...
def pid_diff_collate_fn(batch, pad_val=-1):
    ...
    #즉 전체를 qshft_seqs의 -1이 아닌 갯수만큼은 true(1)을 곱해서 원래 값을 부여하고, 아닌 것은 False(0)을 곱해서 0으로 만듦
    q_seqs, r_seqs, pid_seqs, diff_seqs = \
        q_seqs * mask_seqs, r_seqs * mask_seqs, pid_seqs * mask_seqs, diff_seqs * mask_seqs
